...
BEGIN
	DECLARE @start_time DATE,@end_time DATE, @batch_start_time DATETIME, @batch_end_time DATETIME;
	BEGIN TRY
		...
		PRINT'------------------------------------------------------------------';
		PRINT'Loading Customer Relationship Management Table';
		PRINT'------------------------------------------------------------------';
		...
		PRINT'------------------------------------------------------------------';
		PRINT'Loading Enterprise Resource Planning Table';
		PRINT'------------------------------------------------------------------';
